...
// Page & Posts
export const allPosts = `*[_type == 'article']{..., categories[] ->, countries[] ->, content[]{..., markDefs[]{..., _type=='internalLink'=>{..., "slug": @.reference->slug}}, asset->, images[]{..., asset->}}} | order(publishDate desc)`
...
// Sidebar
export const allCountryPostsQuery = `*[_type == 'country']{..., 'relatedArticles': *[_type == 'article' && references(^._id)]{..., countries[] ->, categories[] ->} | order(publishDate desc)}`
export const allCategoryPostsQuery = `*[_type == 'category']{..., 'relatedArticles': *[_type == 'article' && references(^._id)]{..., countries[] ->, categories[] ->} | order(publishDate desc)}`
